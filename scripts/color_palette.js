...
export class ColorControl {
    ...
    colorScheme;
    action;
    constructor(previewBackground, colorScheme, action) {
        this.#previewBackground = previewBackground;
        this.colorScheme = colorScheme;
        this.action = action;
        addEventListnerById("select_color_palette", "input", (select) => this.changeColorPalette(select));
        addEventListnerById("color_back", "input", (input) => { previewBackground.style.background = input.value; });
        addEventListnerById("color_main", "input", (input) => { colorScheme.noteStroke = input.value; action(this.colorScheme); });
        addEventListnerById("color_sub", "input", (input) => { colorScheme.gridStroke = input.value; action(this.colorScheme); });
        addEventListnerById("color_fill", "input", (input) => { colorScheme.noteFill = input.value; action(this.colorScheme); });
        addEventListnerById("color0", "input", (input) => { colorScheme.setPitchClassColor(0, input.value); action(this.colorScheme); });
        addEventListnerById("color1", "input", (input) => { colorScheme.setPitchClassColor(1, input.value); action(this.colorScheme); });
        addEventListnerById("color2", "input", (input) => { colorScheme.setPitchClassColor(2, input.value); action(this.colorScheme); });
        addEventListnerById("color3", "input", (input) => { colorScheme.setPitchClassColor(3, input.value); action(this.colorScheme); });
        addEventListnerById("color4", "input", (input) => { colorScheme.setPitchClassColor(4, input.value); action(this.colorScheme); });
        addEventListnerById("color5", "input", (input) => { colorScheme.setPitchClassColor(5, input.value); action(this.colorScheme); });
    }
    changeColorPalette(select) {
