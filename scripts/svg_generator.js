...
export function clearChildren(...elements) {
...
export function createPath(d, fill, stroke, strokeWidth) {
...
export function createDiamond(x, y, size, fill, stroke, strokeWidth) {
    return createPath(`M ${x + centerX},${y + centerY - size} l ${size},${size} l -${size},${size} l -${size},-${size} Z`, fill, stroke, strokeWidth);
}
export function createCircle(cx, cy, r, fill, stroke, strokeWidth) {
...
export function createLine(x1, y1, x2, y2, stroke, strokeWidth) {
